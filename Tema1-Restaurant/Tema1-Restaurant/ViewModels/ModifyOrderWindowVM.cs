...
{
    internal class ModifyOrdersWindowVM : BaseVM
    {
        ...
        public ModifyOrdersWindowVM()
        {
            Messenger.Default.Register<OrdersVM>(this, (ReceivedOrder) =>
            {
                TableID = ReceivedOrder.TableID;
                Status = ReceivedOrder.Status;
                TotalCost = ReceivedOrder.TotalCost;
                OrderTime = ReceivedOrder.OrderTime;
            });
        }


        public ModifyOrdersWindowVM(string orderID, string tableID, string status, string totalCost, DateTime orderTime)
        {
            OrderID = orderID;
            TableID = tableID;
            Status = status;
